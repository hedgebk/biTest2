...
public class Encryptor {
    ...
    public static void main(String[] args) {
        try {
            ...
            File file = new File("encryptor.txt");
    ...
    private static void go(FileReader reader) throws Exception {
    ...
    private static void encrypt(Properties properties) throws Exception {
        ...
        if (input != null) {
            ...
            if (output != null) {
                ...
                if (keys != null) {
                    ...
                    encrypt1(input, output, keys, pwd);
                } else {
    ...
    private static void encrypt1(String input, String output, String keys, String pwd) throws Exception {
